  ...
  async uploadFile(
    ...
    try {
      ...
      return createErrorResponse(
        ...
        error.message || 'An error occurred while creating media',
  ...
  async update(
    ...
    try {
      ...
      return createErrorResponse(
        ...
        error.message || 'An error occurred while updating media',
        HttpStatus.BAD_REQUEST,
      );
    }
  }
  ...
  async findAll() {
    try {
      ...
      return createErrorResponse(
        ...
        error.message || 'An error occurred while fetching media',
